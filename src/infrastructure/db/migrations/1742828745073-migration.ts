...
export class Migration1742828745073 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "account_orm_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "account_type" character varying(100) NOT NULL DEFAULT 'current', "balance" double precision NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_ce9216a90d3cce9c96bd85aa63a" PRIMARY KEY ("id"))`);
